...
This is a fork from [https://github.com/MCG-NKU/NSFC-LaTex](https://github.com/MCG-NKU/NSFC-LaTex), but using 楷体 as the main text font. Below is the original README:
